...
EOS;
    ...
    public function testGetAnnotationsWithNoNameInformations()
    {
        ...
        $fileScanner = $this->getMockBuilder('Laminas\Code\Scanner\FileScanner')
    ...
    public function testGetTraits()
    {
        ...
        $reflectionClass = new ClassReflection('LaminasTest\Code\Reflection\TestAsset\TestTraitClass4');
        $traitsArray = $reflectionClass->getTraits();
        $this->assertInternalType('array', $traitsArray);
        $this->assertCount(1, $traitsArray);
        $this->assertInstanceOf('Laminas\Code\Reflection\ClassReflection', $traitsArray[0]);
