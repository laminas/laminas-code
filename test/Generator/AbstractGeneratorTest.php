...
class AbstractGeneratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $generator = $this->getMockForAbstractClass('Laminas\Code\Generator\AbstractGenerator', [
            [
                'indentation' => 'foo',
            ]
        ]);
    ...
    /**
     * @expectedException \Laminas\Code\Generator\Exception\InvalidArgumentException
     */
